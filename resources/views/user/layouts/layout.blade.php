...
<body>
    <main>
        ...
        <div id="app-layout" class="overflow-x-hidden flex">
            <!-- start navbar -->
            @if (!in_array(Route::currentRouteName(), ['user.bootcamp.modul.materi', 'user.livecoding.show', 'user.quiz.show']))
            ...
            <div id="app-layout-content"
                class="min-h-screen w-full min-w-[100vw] md:min-w-0 {{ !in_array(Route::currentRouteName(), ['user.bootcamp.modul.materi', 'user.livecoding.show', 'user.quiz.show']) ? 'ml-[15.625rem]' : '' }} [transition:margin_0.25s_ease-out]">
                <!-- start navbar -->
